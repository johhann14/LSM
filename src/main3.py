...
list_generator = []
list_spike = []
list_rate = [rate for i in range(40)]
I = 21e-9
for i in range(40):
    spike_inputs = generator.generate(list_rate[i])
...
#on choisit les neurons du liquid qui recoivent les spikes input
w = (np.random.rand(40, 135) < 0.6).astype(int)
print(w)
"""
